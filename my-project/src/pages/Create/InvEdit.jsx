...
const navigate=useNavigate();
  ...
  axios.post(`https://invoicerly-server.vercel.app/invoices`,{
    email,
    srNo,
    date,
    lastDate,
    ...
    console.log(result);
navigate(`/dash/invoice/invprint/${result.data._id}`)
  })
      ...
      <div className="content-area w-full px-5 scrol">
        ...
        <div className="row row-cols-1 row-cols-md-3 mb-3">
          <div
            ...
            style={{ width: "892.5px", height: "1263px" }}
          >
            ...
            <div className="pt-4 pb-6">
              <form onSubmit={handleSubmit}>
                <div className="row w-8/12  mb-3">
                  <label className="col-sm-3 font-semibold col-form-label">Inv. ID *</label>
                ...
                <div className="row w-8/12  mb-3">
                  <label className="col-sm-3 font-semibold col-form-label">Date *</label>
                  <div className="col-sm-8">
                    <input
                      type="date"
                ...
                <div className="row w-8/12  mb-3">
                  <label className="col-sm-3 font-semibold col-form-label">Last date *</label>
                  <div className="col-sm-8">
                    <input
                      type="date"
                      className="form-control border-b-2"
                ...
                <div className="flex gap-3 mb-8 justify-center flex-row">
                  <div className="w-6/12 h-44 px-2 border-2">
                    ...
                    <p className="text-gray-700 font-semibold pb-3">Company Name: SkyNet</p>
                    <p className="text-gray-700 font-semibold">Owner Name: India</p>
                  </div>
