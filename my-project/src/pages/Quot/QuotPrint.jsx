        ...
        <div className="row row-cols-1 row-cols-md-3 mb-3">
          ...
          >
            ...
            <div className="pt-8  pb-6">
                <div className="flex ">
                 ...
                 <div className="row w-8/12  mb-3">
                  <label className="col-sm-4 font-semibold text-xl  text-gray-700 col-form-label">Quot. Id</label>
                ...
                <div className="row w-8/12  mb-3">
                  <label className="col-sm-4 font-semibold text-xl  text-gray-700 col-form-label"> Issued date </label>
                  <div className="col-sm-8 text-xl  text-gray-600 font-bold  pt-1">
                ...
                <div className="row w-8/12  mb-3">
                  <label className="col-sm-4 font-semibold text-xl  text-gray-700 col-form-label">Valid Till </label>
                  <div className="col-sm-8 text-xl  text-gray-600   font-bold pt-1">
                ...
                <div className="flex gap-3 mb-8 justify-center  mt-10 flex-row">
                  <div className="w-6/12 h-44 px-2  border-slate-300 border-2">
                    ...
                    <p className="text-gray-700 font-semibold pb-1">Company Name: {userinfo.company}</p>
                    <p className="text-gray-700 font-semibold pb-1">Owner Name: {userinfo.name}</p>
                    <p className="text-gray-700 font-semibold">Mobile no: {userinfo.mobile}</p>
                  </div>
            ...
            <div className="  w-full  flex justify-center font-semibold align-middle pt-3 gap-5   h-14 bg-slate-300" style={{borderRadius:"9px"}}>
              <div >EmailId: {userinfo.email}</div>
              <div> Account no.: {userinfo.accountNumber}</div>
