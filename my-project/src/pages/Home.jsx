...
const Home = () => {
  ...
  const handleCheck = async (e) => {
    ...
    try {
      ...
      if (result.data.status === "success") {
        ...
        setShowSignInModal(true); // Show Clerk sign-in modal if status is not success
      }
    } catch (err) {
  ...
  return (
    <div className='all'>
      ...
      <h1 className="text-2xl fw-semibold mb-4 text-center pt-2 text-gray-600">Your one-stop GST accounting software.</h1>
      ...
      <div className="px-4 pt-5 my-5 text-center border-bottom">
        <h1 className="display-5 fw-bold text-body-emphasis">Ensure 100% GST Compliance</h1>
      ...
      {showSignInModal && (
        <SignIn
          ...
          appearance={{ elements: { modal: { zIndex: 9999 } } }}
